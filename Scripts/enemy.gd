...
func _ready():
	...
	if attack_area:
		attack_area.collision_layer = 3  # Enemy attack on layer 3
		attack_area.collision_mask = 2   # Detect player hurtboxes on layer 2
		attack_area.monitoring = true
		attack_area.monitorable = true
		print("Enemy Attack area collision_layer: ", attack_area.collision_layer, " collision_mask: ", attack_area.collision_mask)

	if hurtbox:
		hurtbox.collision_layer = 4      # Enemy hurtbox on layer 4
		hurtbox.collision_mask = 1       # Detect player attacks on layer 1
		hurtbox.monitoring = true
		hurtbox.monitorable = true  
		print("Enemy Hurtbox collision_layer: ", hurtbox.collision_layer, " collision_mask: ", hurtbox.collision_mask)
